package com.studycase.vanard.vianrasyiddiyatma_1202154186_modul6;
...
import com.studycase.vanard.vianrasyiddiyatma_1202154186_modul6.adapter.CommentAdapter;
import com.studycase.vanard.vianrasyiddiyatma_1202154186_modul6.model.Comment;
import com.studycase.vanard.vianrasyiddiyatma_1202154186_modul6.model.User;
        ...
        databaseUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!TextUtils.isEmpty(review)){
                    ...
                    Comment track = new Comment(id, user.getUsername(), review, timestamp*(-1));
    ...
    protected void onStart() {
        ...
        databaseComments.orderByChild("timestamp").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(CommentPostActivity.this));
